...
//     {
//       NoFact: "FEBR_4059",
//       FechaFact: "2021-05-07 ",
//       Cliente: "CLINICA MONTERIA S.A ",
//       FechaVencimiento: "2021-04-07",
//       VlTotalFactura: "14.557.216",
//       Saldo: "14.557.216",
//     },
//     {
//       NoFact: "FEBR_4059",
...
//   const table = document.querySelector(".table-info__body");
...
//             <th class="table-fechas__head-th">
//               <i>Impreso:</i> ${
//                 datosReciboSaldosPdf.fechaActual
//                   ? datosReciboSaldosPdf.fechaActual
//                   : ""
//               }
//             </th>
...
//         </thead>
//       </table> -->
//       <table id="table-info" class="table-info" border="1">
...
//           </tr>
//         </thead>
//         <tbody class="table-info__body"></tbody>
//       </table>
//     </main>
//     <script>
...
//       ${datos.map(
//         (item) =>
//           (table.innerHTML += `<tr class="table-info__head-tr"><th class="table-info__head-th">${item.NoFact}</th><th class="table-info__head-th">${item.FechaFact}</th><th class="table-info__head-th">${item.Cliente}</th><th class="table-info__head-th">${item.FechaVencimiento}</th><th class="table-info__head-th">${item.VlTotalFactura}</th> <th lass="table-info__head-th">${item.Saldo}</th></tr>`)
//       )}
//     </script>
//   </body>
// </html>
